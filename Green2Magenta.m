...
% This function provides the colorcodes for green and magenta.
% num: an integer that determines the resolution

green2Magenta = [];
whiteRange = floor(0.1*num); % Size of the region with no color
